...
begin
   ...
   begin
   This_Player.RandomFlyTo('HL001~1'); 
   This_Npc.NpcNotice(This_Player.Name + '进入了火龙洞,打宝去了！');
  begin
    This_Player.DecLF(0, 150, false); 
   end;
  end 
  else  
  begin
 ...
 begin
   ...
   begin
      This_NPC.NpcDialog(This_Player,
      '火龙洞.里面各种火龙系列的BOSS.等你来挑战哦\ \'
	  
	  +'火龙洞危险地图.爆各种珍稀物品,爆星王类装备!|\'
	  
	  +'地图需求:54级进入.<150点灵符/c=red>|\'
