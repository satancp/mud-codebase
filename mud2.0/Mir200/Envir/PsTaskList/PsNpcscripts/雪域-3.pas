...
procedure _heian;
begin
   if This_Player.MyLFnum >= 240 then
   begin
   if This_Player.Level >= 58 then
   begin
   This_Player.Flyto('xy1',20 ,60);
   This_Npc.NpcNotice(This_Player.Name + '前往雪域！');
  begin
    This_Player.DecLF(0, 240, false); 
   end;
  end 
  else  
  begin
