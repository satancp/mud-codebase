...
begin 
    ...
    This_Player.Flyto('D2008',80 + random(3) - 1,80 + random(3) - 1); 
end; 
 
procedure domain; 
begin 
    This_NPC.NpcDialog(This_Player, 
    '这里通向满是野猪的封魔殿，\如果你在历练的过程中遇到<邪恶毒蛇/c=red>，<虹魔猪卫/c=red>，<虹膜蝎卫/c=red>，\就想办法击败它们吧，它们携带的各种宝物会使你背包满满的。\ \'  
    +'|{cmd}<前往霸者大厅/@goToMonMap>\' 
