...
begin
  ...
  '你好，' + This_Player.Name + '这里是藏宝阁23号，你可以直接掷骰子，\'
...
var
  ...
  bBack : Boolean;
begin
  if compareText(This_Player.MapName, 'EM002~23') <> 0 then
    Exit;
  ...
  1,3,5:
    begin
      ...
      This_Player.RandomFlyTo('EM002~24');
  ...
  2,4,6:
    begin
      bBack := True;
      desRoomId := desRoomId - diceNum;
      This_Player.RandomFlyTo('EM002~22');
