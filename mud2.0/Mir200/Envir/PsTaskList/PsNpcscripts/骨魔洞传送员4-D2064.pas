...
begin  
    if This_Player.MapName = 'D2064' then  
    This_Player.Flyto('D2067',150 + random(3) - 1,165 + random(3) - 1);  
end;  
...
begin 
    ...
    '这里通向满是骷髅兵的骨魔洞，如果你在历练的过程中遇到<黄泉教主/c=red>，\勇敢的挑战它吧，无数宝物在向你招手。\ \'   
    +'|{cmd}<前往骨魔洞五层/@goToMonMap>        \' 
