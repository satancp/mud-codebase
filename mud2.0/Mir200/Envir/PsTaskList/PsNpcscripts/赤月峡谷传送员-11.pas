...
begin 
    ...
    +'|{cmd}<前往丛林迷宫/@goToMonMap_57>          ^<前往赤月峡谷南入口/@goToMonMap_58>\' 
    +'|{cmd}<前往赤月峡谷广场/@goToMonMap_59>      ^<前往左回廊/@goToMonMap_60>\' 
    +'|{cmd}<前往抉择之地/@goToMonMap_61>          ^<前往赤月峡谷东入口/@goToMonMap_62>\' 
    +'|{cmd}<前往右回廊/@goToMonMap_63>            ^<前往赤月峡谷北入口/@goToMonMap_64>\' 
