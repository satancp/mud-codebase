...
begin
   ...
   begin 
     ...
     begin 
       ...
       This_NPC.NpcNotice('混沌牛魔王等魔物的活动的区域失去了规则的制约，敌人的概念变得模糊不清，在此区域攻击任何敌人都将不受惩罚。');
       end;
       
       if (This_NPC.CheckMapMonByName('D5071','混沌牛魔王') = 0) then
       begin
       This_NPC.CreateMon('D5071',20,23,10,'混沌牛魔王',1);
       This_NPC.CreateMon('D5071',20,23,10,'混沌牛魔祭司',5);
       This_NPC.CreateMon('D5071',20,23,10,'混沌牛魔将军',5);
       This_NPC.CreateMon('D5071',20,23,10,'混沌牛魔法师',5);
       This_NPC.CreateMon('D5071',20,23,10,'混沌牛魔侍卫',5);
       ...
       This_NPC.CreateMon('D5072',27,20,7,'混沌牛魔祭司',5);
       This_NPC.CreateMon('D5072',27,20,7,'混沌牛魔将军',5);
       This_NPC.CreateMon('D5072',27,20,7,'混沌牛魔法师',5);
       This_NPC.CreateMon('D5072',27,20,7,'混沌牛魔侍卫',5);
       ...
       This_NPC.CreateMon('6',423,65,10,'混沌牛魔祭司',5);
       This_NPC.CreateMon('6',423,65,10,'混沌牛魔将军',5);
       This_NPC.CreateMon('6',423,65,10,'混沌牛魔法师',5);
       This_NPC.CreateMon('6',423,65,10,'混沌牛魔侍卫',5);
       ...
       This_NPC.CreateMon('5',101,267,10,'混沌牛魔祭司',5);
       This_NPC.CreateMon('5',101,267,10,'混沌牛魔将军',5);
       This_NPC.CreateMon('5',101,267,10,'混沌牛魔法师',5);
       This_NPC.CreateMon('5',101,267,10,'混沌牛魔侍卫',5);
       This_NPC.NpcNotice('【混沌之地】苍月岛（101，167）出现混沌牛魔王！');
       end; 
     end; 
     ...
     begin     
       ...
       This_NPC.CreateMon('D701',74,39,6,'混沌牛魔祭司',5);
       This_NPC.CreateMon('D701',74,39,6,'混沌牛魔将军',5);
       This_NPC.CreateMon('D701',74,39,6,'混沌牛魔法师',5);
       This_NPC.CreateMon('D701',74,39,6,'混沌牛魔侍卫',5);
     ...
     if AutoOpenDay(4) = 0 then      //藏宝图开启红字提示 
     begin
        if (GetHour = 0) and (GetMin = 0) then
        This_NPC.NpcNotice('【魔龙宝藏】神秘裁缝已经开始收集藏宝图碎片修复魔龙藏宝图，勇士们可以前往苍月岛衣服店助其达成心愿！');
     end;
     ...
     if (tempTime >= 1300) and (tempTime < 1330) then
     begin
         if (tempTime mod 5) = 0 then
         begin
             pigRdm := random(3) + 1;
             ...
             case pigRdm of
                 ...
                 begin
                    pigX := 100 + random(500);
                    pigY := 100 + random(500);
                    This_NPC.CreateMon('0',pigX,pigX,3,'散财猪',1);
                   // pigStr := '各位玩家请注意：带有大量财宝的散财猪再次降临在比奇省(' + inttostr(pigX) + '，' + inttostr(pigY) + ')附近。'
                 end;
                 3:      //0 420,300-550,500           
                 begin
                    pigX := 420 + random(130);
             ...
             begin
                 This_NPC.NpcNotice('金猪送喜活动开始啦！！' + pigStr);
                 RollMsg('金猪送喜活动开始啦！！' + pigStr);
             end else
             begin
