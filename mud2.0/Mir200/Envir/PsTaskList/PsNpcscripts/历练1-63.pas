...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        if This_NPC.CheckMapMonByName('63','恶魔魔龙') > 80 then
        begin
          This_Npc.NpcDialog(This_Player,          
          '目前已经放出够多的恶魔魔龙，请先消灭完，\如果你在我附近没有看到恶魔魔龙 你可以试着跑远点看看\');
          This_Player.SetS(22,24,720);
          This_Player.DecGold(60000);
        end
        else
        begin
          This_NPC.CreateMon('63',213,117,5,'恶魔魔龙',10);
          This_Player.SetS(22,24,720);
          This_Player.DecGold(60000);
          This_NPC.CloseDialog(This_Player); 
        end;
...
begin
  ...
  begin
    ...
    begin
      ...
      +'我将会在我所站的周围，释放<10只恶魔魔龙/c=red>，当你打死他们后，\'
      +'我就会给你<超额的奖励/c=red>。但如果你没有<打满10只怪/c=red>，\'
      +'可再交付我<60000金币/c=red>。\'
      +'我将再释放<10只恶魔魔龙/c=red>。直到你打满10只怪为止。\'
