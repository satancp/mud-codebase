...
begin
  ...
  '恭喜你进入了<50号/c=red>奖励藏宝阁，在完成我的要求之后，\你还可以得到额外的奖励。请记得在包裹中留下至少五格空间，\'
  ...
  begin
    ...
    1:
      begin
        ...
        This_Npc.NpcNotice('恭喜：' + This_Player.Name + '，在藏宝阁50号获得：热血积分1个！');
      end;
    2,3,4,5,6:
      begin
        This_Player.Give('乾坤令包',dice-1);
        This_Npc.NpcNotice('恭喜：' + This_Player.Name + '，在藏宝阁50号获得：乾坤令包' + inttostr(dice-1) +'个！'); 
      end;
    end;
  end;  
end;
