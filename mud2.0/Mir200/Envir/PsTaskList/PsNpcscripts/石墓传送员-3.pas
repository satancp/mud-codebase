...
begin 
    ...
    '这里通向满是可怕野猪的石墓，\如果你在历练的过程中遇到<邪恶毒蛇、白野猪/c=red>，\就想办法击败它们吧，它们携带的各种宝物会使你背包满满的。\ \'   
    +'|{cmd}<前往石墓一层/@goToMonMap_1>        ^<前往石墓二层/@goToMonMap_2>\' 
    +'|{cmd}<前往石墓三层/@goToMonMap_3>        ^<前往石墓四层/@goToMonMap_4>\' 
    +'|{cmd}<前往石墓五层/@goToMonMap_5>        \' 
