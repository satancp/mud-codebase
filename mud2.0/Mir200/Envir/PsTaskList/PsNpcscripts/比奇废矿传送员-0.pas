...
begin  
    ...
    '这里通向满是僵尸的矿区，如果你在历练的过程中遇到<尸王/c=red>，\一定要击败它,它携带的各种技能书,是众多玩家追求的目标。\ \'   
    +'|{cmd}<前往废矿入口/@goToMonMap_46>        ^<前往废矿区东部/@goToMonMap_47>\' 
    +'|{cmd}<前往矿区一层/@goToMonMap_48>        ^<前往矿区B二层/@goToMonMap_49>\' 
    +'|{cmd}<前往矿物回收站/@goToMonMap_50>      ^<前往废矿区南部/@goToMonMap_51>\' 
