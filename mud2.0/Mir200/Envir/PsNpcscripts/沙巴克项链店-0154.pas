...
begin
  ...
  '喔，呵呵~请爽快地购买项链. 有时我会卖一个很低的价\当我粗心时. 喔，呵呵~. 你是兄弟行会的成员，\我给你个特惠价怎么样? 不错吧?  喔，呵呵~ \听说土城的首饰店老板可以升级雷霆、烈焰、光芒系列首饰，\要么你去找他打听打听吧，或许能对你有帮助。\'
  +'|{cmd}<购买/@buy>项链'+ addSpace('', 24) + '|{cmd}<出售/@sell>项链\'
  +'|{cmd}<修理项链/@repair>\'
  +'|{cmd}<特殊修理/@s_repair>\'
  +'|{cmd}<退出/@doexit>'
  );
