...
begin
    This_NPC.NpcDialog(This_Player,
    '请选择你要回收的装备种类：\'
    +'|{cmd}<回收强化装备/@zhuangDlg~1>        ^<回收赤月装备/@zhuangDlg~2>\'
...
begin
    ...
    begin
        ...
        begin
            ...
            This_NPC.NpcDialog(This_Player,
            '恭喜你获得' + inttostr(getZexpNum(ZBid div 100) div 10000) + '万经验\|'
...
begin
    ...
    This_NPC.NpcDialog(This_Player,
    '你的包裹中有' + inttostr(ZMnum) + '件强化装备，回收可获得:' + inttostr(getZexpNum(1) div 10000 * ZMnum) + '万经验，你确定回收所有强化装备吗？\|'
    +'|{cmd}<确认回收所有强化装备/@ZUma_True>'
    +'|{cmd}<返回/@zhuangDlg~1>');
end;
...
begin
    ...
    This_NPC.NpcDialog(This_Player,
    '恭喜你获得:' + inttostr(getZexpNum(1) div 10000 * ZMnum) + '万经验！\|'
    +'|{cmd}<返回/@zhuangDlg~1>');
...
begin
    ...
    This_NPC.NpcDialog(This_Player,
    '你的包裹中有' + inttostr(ZMnum) + '件赤月装备，回收可获得:' + inttostr(getZexpNum(2) div 10000 * ZMnum) + '万经验，你确定回收所有赤月装备吗？\|'
...
begin
    ...
    This_NPC.NpcDialog(This_Player,
    '你的包裹中有' + inttostr(ZMnum) + '件魔龙装备，回收可获得:' + inttostr(getZexpNum(3) div 10000 * ZMnum) + '万经验，你确定回收所有魔龙装备吗？\|'
...
begin
    ...
    This_NPC.NpcDialog(This_Player,
    '恭喜你获得:' + inttostr(getZexpNum(3) div 10000 * ZMnum) + '万经验！\|'
    +'|{cmd}<返回/@zhuangDlg~3>');
