...
begin  
    if This_Player.MapName = 'D2011' then  
    This_Player.Flyto('D2012',84 + random(3) - 1,84 + random(3) - 1);  
end;  
...
begin  
    ...
    '这里通向满是可怕怪物的封魔殿深层，如果你在历练的过程中遇到<虹魔教主/c=red>，\一定要注意安全，打败它你会获得丰厚的奖励\ \'   
    +'|{cmd}<前往炼狱回廊/@goToMonMap>        \' 
