...
begin 
    ...
    '这里通向满是可怕蜈蚣的地牢，如果你在历练的过程中遇到<触龙神/c=red>，\请小心对待，魔法免疫的它可不是那么容易击败的。\ \'  
    +'|{cmd}<前往死亡棺材/@goToMonMap>            ^<前往生死之间/@goToMonMap_1>\'
    +'|{cmd}<前往传奇部落/@goToMonMap_2>            ^<前往邪恶势力/@goToMonMap_3>\' 
    +'|{cmd}<前往幽冥圣域/@goToMonMap_4>            ^<前往恐怖空间/@goToMonMap_5>\'  
