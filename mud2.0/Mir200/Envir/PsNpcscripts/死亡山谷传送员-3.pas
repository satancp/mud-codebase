...
begin 
    ...
    '这里通向满是可怕蜈蚣的地牢，如果你在历练的过程中遇到<邪恶钳虫/c=red>，\勇敢的打败它吧，各种宝物会塞满你的背包的。\'   
    +'|{cmd}<前往地牢一层东/@goToMonMap_12>         ^<前往地牢一层北/@goToMonMap_13>\' 
    +'|{cmd}<前往地牢一层西2/@goToMonMap_14>        ^<前往地牢一层西/@goToMonMap_15>\' 
    +'|{cmd}<前往地牢一层北2/@goToMonMap_16>        ^<前往传奇部落/@goToMonMap_17>\'
    +'|{cmd}<前往邪恶势力/@goToMonMap_18>           ^<前往幽冥圣域/@goToMonMap_19>\' 
    +'|{cmd}<前往恐怖空间/@goToMonMap_20>           ^<前往未知暗殿/@goToMonMap_65>\' 
