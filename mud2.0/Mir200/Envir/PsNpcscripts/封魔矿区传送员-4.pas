...
begin  
    ...
    '这里通向满是僵尸的封魔矿区，如果你在历练的过程中遇到<尸王/c=red>，\一定要击败它,它携带的各种技能书,是众多玩家追求的目标。\ \'   
    +'|{cmd}<前往封魔矿区/@goToMonMap_21>            ^<前往歧路/@goToMonMap_22>\' 
    +'|{cmd}<前往连接通道/@goToMonMap_23>            ^<前往疾风殿/@goToMonMap_24>\' 
    +'|{cmd}<前往光芒回廊/@goToMonMap_25>            ^<前往烈焰殿/@goToMonMap_26>\' 
    +'|{cmd}<前往雷霆之路/@goToMonMap_27> \' 
