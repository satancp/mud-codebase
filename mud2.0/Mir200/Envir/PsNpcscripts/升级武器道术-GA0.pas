...
begin
     ...
     if ck_gold > 0 then
     begin                                                                                             
       if This_Player.YBNum >= ck_gold then      //检查 元宝 
       ...
       begin
         ...
         begin 
         This_Item.AddPa3 := This_Item.AddPa1 + 3;   //道术+1 
         ck_str :='道术+1'; 
         ck_red :='红字公告';
         ...
         This_Player.PsYBConsum(This_NPC,'ForgeDiaYB',20154,10,1);  //这里扣元宝 
