...
Begin
   ...
   begin
      This_Npc.NpcDialog(This_Player,
      '前几天我去魔龙城采药的时候，\'+
      '无意中发现有个人将一批藏宝图和首饰交给了魔龙教主的手下，\'+
      '可惜天色太黑了没有看清楚这个人的样貌。\ \'+
      '|{cmd}<买药品/@buy> '+addspace(' ',24)+'|{cmd}<卖药品/@sell> \'+
   ...
   begin
      This_Npc.NpcDialog(This_Player,
      '听说了么？这次封魔谷的诅咒消失，其实是因为魔龙教主的出现\'+
      '传说魔龙教主藏有许多稀世珍品，而其中有三把绝世兵刃更是当今\'+
      '最强的武器，看来不在我这边多买点补给是不行的了。\ \'+
      '|{cmd}<买药品/@buy> '+addspace(' ',24)+'|{cmd}<卖药品/@sell> \'+
      '|{cmd}<打听关于特殊药水的消息/@talk> \'+
      '|{cmd}<退出/@doexit>');
   end;
   ...
   begin
      ...
      '无意中发现有个人将一批藏宝图和首饰交给了魔龙教主的手下，\'+
      '可惜天色太黑了没有看清楚这个人的样貌。\ \'+
      '|{cmd}<合成火龙神品/@hecheng>'+addspace(' ',19)+'|{cmd}<查看合成火龙神品配方/@lookfor>\'+
