...
begin
  ...
  '前些日子，从西方来的游商说起，在大漠中有僧侣发现一处藏宝洞穴。\'
  +'洞穴大门每天会定时开启，其中存有许多先朝典籍散页，文字奇古，\'
  +'料想其价值难以估量。我虽有心前往探访，无奈洞中却有大量妖魔镇\'
  +'守，让我一介书生如何去得。又有传闻说，其中一些书页已经辗转散\'
  +'布在市井之间，或许要待有缘之士才能获得。\'
  +'人世间事，多半不如人意，想来便是如此吧。\ \'
  +'|{cmd}<继续/@shuye_next>'
  );
...
procedure _shuye_next;
begin
  This_Npc.NpcDialog(This_Player,
  '年轻人，听我老头子唠叨到这里，想来你也是有心之人。\'
  +'这样吧，虽然大学士乃一闲职，但我平生酷爱藏书，书中颇有些珍奇\'
  +'典籍，其中不乏武学秘笈。若是你能寻访到足够的书页，集成卷轴，\'
...
begin
  ...
  +'在给我1张书页的同时，能给我们比奇学院捐献<5元宝/c=red>研究经费的话，\'
  +'我能破例给你记录5点贡献度。\'
  +'当你在我这里的贡献度满500的时候，我将以珍藏的秘籍相赠。\'
  +'勇士，你带来我需要的东西了么？\ \'
...
begin
  ...
  begin
    ...
    begin
        This_Player.SetV(26,11,temp - 500);
      This_Player.Give(Book_Name,1);
        This_Player.AddLogRec(9, Book_Name, 811116, 1, '扣除1000贡献度获得');
      This_Npc.NpcDialog(This_Player,
      '你成功兑换到了：' + Book_Name + '！\ \'
      +'|{cmd}<返回/@NewSkill_2>'
      );
...
begin
  ...
  +'机制。当您在我这里记录的贡献度满足500点，并且您的级别满足\'
