...
begin 
    ...
    '这里通向满是牛魔怪物的牛魔寺庙，如果你在历练的过程中遇到\<牛魔王/c=red>，请你一定当心，能收集到玛法大陆终极武器的它可不是那么\简单就被击败的。\ \'   
    +'|{cmd}<前往牛魔寺庙一层/@goToMonMap_34>          ^<前往牛魔寺庙二层/@goToMonMap_35>\' 
    +'|{cmd}<前往牛魔寺庙三层/@goToMonMap_36>          ^<前往牛魔寺庙四层/@goToMonMap_37>\' 
    +'|{cmd}<前往牛魔寺庙五层/@goToMonMap_38> \' 
